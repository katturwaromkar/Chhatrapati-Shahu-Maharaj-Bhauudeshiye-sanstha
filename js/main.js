...
function initDonationModal() {
  const donationBtns = document.querySelectorAll('.open-donation-modal-btn');
  ...
  if (!modal) {
    ...
    modal.style.cssText = 'position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(15,23,42,0.75); backdrop-filter:blur(5px); display:none; align-items:center; justify-content:center; z-index:99999; padding:15px;';
    modal.innerHTML = `
